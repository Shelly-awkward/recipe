...
window.RECIPES = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "小番茄（去蒂）", amount: 8, unit: "顆", scale: true },
    ...
    steps: [
      ...
      "最後放小番茄，煮 3 分鐘就熄火，用餘溫悶著。番茄煮久會整顆爛掉。",
      "熄火後靜置 30 分鐘以上再吃，這段時間才是真正入味的時候。盛碗淋一點鍋裡的湯，旁邊放黃芥末醬。"
    ],
    notes: "這份菜單刻意不用市售黑輪、甜不辣、魚板那類加工煉製品，鮮味改由昆布、柴魚、蘿蔔、香菇、玉米一起出。想加手工丸子，請看另一篇「手工鮮蝦魚丸」，起鍋前 10 分鐘再放進去。隔夜更好吃：放涼後整鍋冰冰箱，隔天小火回溫，但雞蛋和番茄建議先撈出來另外冰，免得過鹹過爛。吃素就把柴魚換成乾香菇 5 朵加曬乾干貝或昆布加倍，豬肉捲改包豆腐和紅蘿蔔絲。湯變少就補水再補一點醬油和味醂，比例大約 5 比 1 比 1。"
  },
  {
